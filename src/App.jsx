    ...
    <section className='text-gray-700 border-b' id='home'>
      <div className='flex container mx-auto py-20 px-5 flex-col md:flex-row items-center'>
        <div className='md:w-1/2 flex-grow mb-16 lg:pr-24 md:pr-16 text-center md:text-left'>
          <h1 className='text-3x1 sm:text-6x1 text-gray-900 font-medium mb-4'>NisshoCode<br />
          My Portfolio Website</h1>
          <p className='mb-8 leading-relaxed'>
            現在、Webエンジニアとしてデビューしたてのほやほやです。得意な言語はHTML、CSS、JavaScript、TypeScript、PHP、SQL、ReactなどWeb全般とPythonです。自身が作ったものを公開しておりますので、ぜひ見ていってください。
          </p>
          <button className='text-white bg-green-500 py-2 px-6 border-0 rounded text-lg hover:bg-green-500 duration-300'>Contact Me</button>
        </div>
        <div className='md:w-1/2 lg:max-w-lg w-5/6'>
        <img src="C:\Users\WebEngineer.E10.000\Desktop\dev\tailwindcss-portfllio\public\myPicture.png" alt="自分の写真" />
        </div>
      </div>
    </section>
    ...
    <section className='text-gray-700 border-t border-gray-200'>
      <div className='container px-5 py-24 mx-auto'>
        <div className='text-center mb-20'>
          ...
          <p className='pb-10'>
            これまで、マーケティング業界に数年間、財務分析を行っていました。現在はIT業界でシステム構築に従事しながら副業としてWebサイトやWebAppを個人として受注しています。また、投資やコンサルティングも積極的に行っており、ご相談されたい方はコンタクトお待ちしております。
          </p>
          <p>いかに個人としての成果物を公開しています。主にSNSなどのChatアプリの構築をReactのJSやTSで実装しています。また、Pythonを使ってAIによる株価の予測サイトを構築しました。また、数件の事業所のWebサイトの構築など多岐にわたります</p>
        </div>  
...
>
  ...
  />
            ...
            <div>
              <p>ReactとJavaScriptで投稿機能つきのChatアプリ、仕様はReact、JavaScript、html、css、etcetcを実装しています。</p>
    ...
    <section className='text-gray-700 border-t border-gray-200'>
      <div className='container px-5 py-24 mx-auto flex flex-wrap'>
        ...
        <div className='lg:pl-12 lg:py-6 w-full lg:w-1/2'>
          <h1 className='text-2x1 sm:text-3x1 font-medium text-gray-900 mb-10 text-center lg:text-left'>My Slills</h1>
